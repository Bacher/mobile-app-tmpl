    ...
    render() {
        ...
        return (
            <div className={cn('notifications', {
                'notifications_rising':    rising,
                'notifications_hiding':    hiding,
                'notifications_move-back': hiding && !manual,
            })} ref="root" onTouchStart={this._onBgClick}>
                <div className="notification-panel" ref="panel">
